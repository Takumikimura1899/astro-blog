...
export const vpcDeck: Deck = {
	...
	cards: [
		...
		{
			id: "vpc-31",
			question: "NATゲートウェイとは？",
			answer:
				"プライベートサブネットからインターネットへの\n一方向通信を可能にするサービス\n\nNAT = Network Address Translation\n（ネットワークアドレス変換）",
		},
		{
			id: "vpc-32",
			question: "NATゲートウェイの主な用途は？",
			answer:
				"プライベートサブネット内のEC2等が\nインターネットにアクセスするため\n\n例：\n・ソフトウェアのアップデート\n・外部APIへのリクエスト",
		},
		{
			id: "vpc-33",
			question: "NATゲートウェイはどこに配置する？",
			answer:
				"パブリックサブネット内\n\nプライベートサブネットからの通信を\nNATゲートウェイ経由でIGWへ転送する",
		},
		{
			id: "vpc-34",
			question: "NATゲートウェイを使った\n通信の流れは？",
			answer:
				"プライベートサブネットのEC2\n　↓\nNATゲートウェイ（パブリックサブネット）\n　↓\nインターネットゲートウェイ\n　↓\nインターネット",
		},
		{
			id: "vpc-35",
			question: "IGWとNATゲートウェイの違いは？",
			answer:
				"IGW：双方向通信\n　→ インターネットからもアクセス可能\n\nNATゲートウェイ：一方向通信\n　→ 内部から外部へのみ（外部から開始不可）",
		},
		{
			id: "vpc-36",
			question: "NATゲートウェイの通信が\n一方向である理由は？",
			answer:
				"セキュリティのため\n\n・内部からの通信開始 → OK\n・外部からの通信開始 → NG\n\nプライベートリソースを外部から保護",
		},
		{
			id: "vpc-37",
			question: "NATゲートウェイに必要なものは？",
			answer:
				"1. Elastic IP（固定パブリックIP）\n2. パブリックサブネットへの配置\n3. IGWへのルート（パブリックサブネットのルートテーブル）",
		},
		{
			id: "vpc-38",
			question:
		...
		{
			id: "vpc-39",
			question: "NATゲートウェイの課金体系は？",
			answer:
				"1. 時間課金（起動している間）\n2. データ処理量に応じた課金\n\n使わないときは削除を検討\n（Elastic IPも別途課金あり）",
		},
		{
			id: "vpc-40",
			question: "NATインスタンスとNATゲートウェイの違いは？",
			answer:
				"NATインスタンス：\n　・EC2で自分で構築\n　・安価だが管理が必要\n\nNATゲートウェイ：\n　・マネージドサービス\n　・高可用性、自動スケール",
		},
		{
			id: "vpc-41",
			question: "高可用性のためのNATゲートウェイ構成は？",
			answer:
				"各AZに1つずつNATゲートウェイを配置\n\n・AZ-aのプライベート → AZ-aのNAT\n・AZ-cのプライベート → AZ-cのNAT\n\nAZ障害時も他のAZで継続可能",
		},
	],
};
